...
function runWarning() {
  ...
  if (wiewStatusLoad.value !== "error") {
    ...
    circleBar.value.classList = "circle-bar-size dots-warning";
    setTimeout(() => {
      ...
      <div class="wiew-circle-svg">
        ...
        <div class="info-circle-position">
          ...
          <div
            ...
            class="wiew-circle-error dots-circle-complette"
          >
            <svg
              width="48"
              height="48"
          ...
          <div
            ...
            class="wiew-circle-warning dots-circle-complette"
          >
            <svg
              fill="rgb(233, 175, 17)"
              width="60px"
