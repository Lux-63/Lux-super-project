...
<template>
  <PageDescription>
    Игра "Найди сокровище", в которой игрок должен найти спрятанное сокровище на
    карте. Была написана как отработка координантной системы и взаимодействия с
    мышью. Изначально была написана на <b>чистом JavaScript</b>.',
  </PageDescription>
